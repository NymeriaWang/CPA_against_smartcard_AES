...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RECOMMENDED PARAMETERS FOR KNOWN KEY  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numberOfTraces = 200;
traceSize = 370000;
offset = 40000;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RECOMMENDED PARAMETERS FOR UNKNOWN KEY  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%numberOfTraces = 150;
%traceSize = 550000;
%offset = 0;
...
for BYTE=byteStart:byteEnd  
    ...
    for K = keyCandidateStart:keyCandidateStop                            
        ...
        for i=1:numberOfTraces
            KxorP = bitxor(K,plaintext(i,BYTE));
            S_out = SubBytes (KxorP+1);
            powerHypothesis(i,K+1) = KxorP;%byte_Hamming_weight(S_out+1);
